...
echo "  ${GR1}image:${NC} habi39/node-web-app "
echo "  ${GR1}port :${NC} 8080\n"
...
echo "\n${GR}Creating ingress object of habi39/node-web-app${NC}"
kubectl apply -f backend-ingress.yaml 

echo "\n${YL}Waiting for backend-ingress to be ready...${NC}"
sleep 45
